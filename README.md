...
of a transport sustainability Key Performance Indicators (KPI) framework. Gelato turns MATSim outputs into transport
sustainability KPI metrics, and exists to provide a runnable application with which to better
understand and explore the framework. As such, it should be regarded as a by-product of the framework rather
