...
| <ul><li>Quality of Life</li><li>Mobility System Performance</li></ul>    | PT Wait Time   | `kpi-pt-wait-time.csv.gz`   | Average time waiting for a PT boarding                                                        | Average trip wait times by transport mode.                                                                                                                         | `intermediate-pt-wait-time.csv.gz`   |
