...
| Global Environment                                                    | GHG Emissions               | `kpi-ghg-emissions.csv.gz`                                                   | Total Emissions emitted by cars and buses                                                                              | Total kilometres travelled by modes car and bus, multiplied by emission factors of 0.222 and 1.372, respectively.                                                                                                                                                                                                                                                                                                                                             | `intermediate-ghg-emissions.csv.gz`               |
