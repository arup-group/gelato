...
| <ul><li>Social</li><li>Mobility System Performance</li></ul>      | PT Wait Time   | `kpi-pt-wait-time.csv.gz`   | Average time waiting for a PT or DRT boarding                                                 | Average trip wait times by transport mode.                                                                                                                         | `intermediate-pt-wait-time.csv.gz`   |
